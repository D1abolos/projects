...
class user
{
	...
	static function GenerateForm(){
		...
		<input name=\"email\" type=\"email\" pattern=".$patternemail." placeholder=\"name@mail.ru\" required> <br/>		
		<input name=\"password\" type=\"password\" pattern=".$patternpswd." placeholder=\"********\" required> <br/>		
		<br/>
